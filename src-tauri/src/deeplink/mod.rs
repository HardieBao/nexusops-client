//! Deep link import functionality for NexusOps Client
//!
//! This module implements the nexusops:// protocol for importing configurations
...
///
/// Represents a parsed nexusops:// URL ready for processing.
