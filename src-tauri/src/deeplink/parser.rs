...
//!
//! Parses nexusops:// URLs into DeepLinkImportRequest structures.
...
/// Parse a nexusops:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// nexusops://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "nexusops" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'nexusops', got '{scheme}'"
        )));
    }
