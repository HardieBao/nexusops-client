...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::team_tool_usage_history,
            commands::team_tool_observation,
            commands::team_clear_tool_usage_history,
            ...
            commands::team_wait_idle,
            commands::teamai_run,
            commands::teamai_export_candidate,
            commands::teamai_preview,
            commands::teamai_apply,
            commands::teamai_retry_acks,
            commands::teamai_ack_status,
