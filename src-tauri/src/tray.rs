    ...
    pub fn from_language(language: &str) -> Self {
        match language {
            "en" => Self {
                ...
                open_website: "Open NexusOps Client repository",
            ...
            "ja" => Self {
                ...
                open_website: "NexusOps Client リポジトリを開く",
            ...
            "zh-TW" => Self {
                show_main: "開啟主介面",
                open_website: "開啟 NexusOps Client 儲存庫",
            ...
            _ => Self {
                show_main: "打开主界面",
                open_website: "打开 NexusOps Client 仓库",
...
pub fn create_tray_menu(
    ...
    // 顶部：打开主界面 / 打开 NexusOps Client 仓库
    let show_main_item =
    ...
    match event_id {
        ...
        "open_website" => {
            if let Err(e) = app.opener().open_url(
                "https://github.com/HardieBao/nexusops-client",
                None::<String>,
            ) {
                log::error!("打开 NexusOps Client 仓库失败: {e}");
            }
        }
        "lightweight_mode" => {
